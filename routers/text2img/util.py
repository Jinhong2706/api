...
def get_image_lifetime() -> int:
    ...
    try:
        ...
        logger.warning(f"Invalid IMAGE_LIFETIME_HOURS value: {lifetime_hours}, using default 24 hours")
        return 24 * 3600

def cleanup_expired_files(data_dir: str = "data", lifetime_seconds: Optional[int] = None) -> int:
